...
//////////////////////////////////////////////////////////////////////
int beamsource::Load(istream &fs)
  // Loads beamsource position/orientation
{
  ...
  cout << "beamsource position/orientation file\n";
...
//////////////////////////////////////////////////////////////////////
int beamsource::SetDefault()
// set default values for source parameters
{
  InputDeviceName[0] = "BeamScreen"; // input beamscreen device name
